...
Scripts are written for DAISY pipeline 29 September 2007 test release.
...
1. Unzip the scripts in a folder.
2. Copy all the files into 
C:\Documents and Settings\xx user\Application Data\Freedom Scientific\JAWS\XX version\Settings\enu 
3. Start DAISY pipeline.
4. Press Insert +0 to open script file and compile it using Control + s.
