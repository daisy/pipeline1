...
/**
 * 
 * The default concrete subclass of the <code>DatatypeAdapter</code>, which uses
 * a {@link Text} widget to edit the parameter value.
 * 
...
public class DefaultAdapter extends DatatypeAdapter {
	 ...
	 * presenting the parameter name, then calls {@link
	 * #doCreateControl(Composite) to create the main control, and then sets
	 * layout data to these controls.}
	 * </p>
	 * 
	 * @param parent
	...
	protected static <T> T illegalArgument(T obj, String message) {
