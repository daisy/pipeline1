...
public abstract class EFileFilter implements FileFilter {
	 ...
	 * in a pathname list.
	 * <p>
	 * The <code>EFileFilter</code> implementation of this interface dispatches
	 * to the {@link #acceptEFile(EFile)} and {@link #acceptDir(Directory)}
	 * methods.
	 * </p>
	 * 
	 * @param file
	...
	public boolean accept(File file) {
		...
		if (file.isDirectory()) {
			try {
				...
				// TODO log("Couldn't create Directory from file " + file, e);
				return false;
			}
		} else {
