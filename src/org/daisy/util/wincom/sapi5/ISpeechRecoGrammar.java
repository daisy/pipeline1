...
public interface ISpeechRecoGrammar extends Com4jObject {
    ...
    @VTID(9)
    void state(
        org.daisy.util.wincom.sapi5.SpeechGrammarState state);
     ...
     */
    @VTID(11)
    org.daisy.util.wincom.sapi5.ISpeechGrammarRules rules();

    @VTID(11)
    @ReturnValue(defaultPropertyThrough={org.daisy.util.wincom.sapi5.ISpeechGrammarRules.class})
    org.daisy.util.wincom.sapi5.ISpeechGrammarRule rules(
        int index);
    ...
    void cmdLoadFromFile(
        ...
        @DefaultValue("0")org.daisy.util.wincom.sapi5.SpeechLoadOption loadOption);
    ...
    void cmdSetRuleState(
        ...
        org.daisy.util.wincom.sapi5.SpeechRuleState state);
    ...
    void setWordSequenceData(
        ...
        int textLength,
        org.daisy.util.wincom.sapi5.ISpeechTextSelectionInformation info);
     ...
     */
    @VTID(25)
    org.daisy.util.wincom.sapi5.SpeechWordPronounceable isPronounceable(
