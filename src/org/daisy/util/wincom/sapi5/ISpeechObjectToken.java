...
public interface ISpeechObjectToken extends Com4jObject {
     ...
     */
    @VTID(8)
    org.daisy.util.wincom.sapi5.ISpeechDataKey dataKey();

    /**
     * Category
     */
    @VTID(9)
    org.daisy.util.wincom.sapi5.ISpeechObjectTokenCategory category();
    ...
    com4j.Com4jObject createInstance(
        ...
        @DefaultValue("23")org.daisy.util.wincom.sapi5.SpeechTokenContext clsContext);
    ...
    java.lang.String getStorageFileName(
        ...
        org.daisy.util.wincom.sapi5.SpeechTokenShellFolder folder);
