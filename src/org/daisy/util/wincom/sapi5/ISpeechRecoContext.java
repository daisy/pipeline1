...
public interface ISpeechRecoContext extends Com4jObject {
     ...
     */
    @VTID(7)
    org.daisy.util.wincom.sapi5.ISpeechRecognizer recognizer();

    /**
     * AudioInInterferenceStatus
     */
    @VTID(8)
    org.daisy.util.wincom.sapi5.SpeechInterference audioInputInterferenceStatus();
    ...
    @VTID(10)
    void voice(
        org.daisy.util.wincom.sapi5.ISpeechVoice voice);
    ...
    void voicePurgeEvent(
        org.daisy.util.wincom.sapi5.SpeechRecoEvents eventInterest);

    /**
     * VoicePurgeEvent
     */
    @VTID(15)
    org.daisy.util.wincom.sapi5.SpeechRecoEvents voicePurgeEvent();
     ...
     */
    @VTID(17)
    org.daisy.util.wincom.sapi5.SpeechRecoEvents eventInterests();
    ...
    @VTID(20)
    void state(
        org.daisy.util.wincom.sapi5.SpeechRecoContextState state);
    ...
    @VTID(22)
    void retainedAudio(
        org.daisy.util.wincom.sapi5.SpeechRetainedAudioOptions option);

    /**
     * RetainedAudio
     */
    @VTID(23)
    org.daisy.util.wincom.sapi5.SpeechRetainedAudioOptions retainedAudio();
     ...
     */
    @VTID(25)
    org.daisy.util.wincom.sapi5.ISpeechAudioFormat retainedAudioFormat();
     ...
     */
    @VTID(28)
    org.daisy.util.wincom.sapi5.ISpeechRecoGrammar createGrammar(
     ...
     */
    @VTID(29)
    org.daisy.util.wincom.sapi5.ISpeechRecoResult createResultFromMemory(
