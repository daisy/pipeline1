...
public abstract class _ISpeechVoiceEvents {
    ...
    public void voiceChange(
        int streamNumber,
        java.lang.Object streamPosition,
        org.daisy.util.wincom.sapi5.ISpeechObjectToken voiceObjectToken) {
            throw new UnsupportedOperationException();
    }
    ...
    public void phoneme(
        ...
        int duration,
        short nextPhoneId,
        org.daisy.util.wincom.sapi5.SpeechVisemeFeature feature,
    ...
    public void viseme(
        ...
        java.lang.Object streamPosition,
        int duration,
        org.daisy.util.wincom.sapi5.SpeechVisemeType nextVisemeId,
        org.daisy.util.wincom.sapi5.SpeechVisemeFeature feature,
        org.daisy.util.wincom.sapi5.SpeechVisemeType currentVisemeId) {
            throw new UnsupportedOperationException();
    }
