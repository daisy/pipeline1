...
public interface ISpVoice extends org.daisy.util.wincom.sapi5.ISpEventSource {
    @VTID(13)
    void setOutput(
    ...
    @VTID(14)
    org.daisy.util.wincom.sapi5.ISpObjectToken getOutputObjectToken();

    @VTID(15)
    org.daisy.util.wincom.sapi5.ISpStreamFormat getOutputStream();
    ...
    @VTID(19)
    org.daisy.util.wincom.sapi5.ISpObjectToken getVoice();
    ...
    int speakStream(
        ...
        @VTID(24)
        void setPriority(
            org.daisy.util.wincom.sapi5.SPVPRIORITY ePriority);

        @VTID(25)
        org.daisy.util.wincom.sapi5.SPVPRIORITY getPriority();

        @VTID(26)
        void setAlertBoundary(
            org.daisy.util.wincom.sapi5.SPEVENTENUM eBoundary);

        @VTID(27)
        org.daisy.util.wincom.sapi5.SPEVENTENUM getAlertBoundary();
