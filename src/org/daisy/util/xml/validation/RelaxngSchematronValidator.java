...
public class RelaxngSchematronValidator implements Validator, ErrorHandler {
 ...
 //       try {         	
        	...
        	//builder.put(ValidateProperty.ENTITY_RESOLVER, CatalogEntityResolver.getInstance());
        	            
 //       } catch (CatalogExceptionNotRecoverable cenr) {
 //           throw new ValidationException(cenr.getMessage(),cenr);
 //       }
        ...
        try {
            ...
            if (useSchematron) {
                ...
                //Source xslt = new StreamSource(new File(System.getProperty("dmfc.home") + File.separator + "resources", "RNG2Schtrn.xsl"));
