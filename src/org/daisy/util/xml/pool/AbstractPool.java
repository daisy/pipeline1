...
public abstract class AbstractPool {
	protected Map mProcessorCache = null; 		//key=Map<propsAndFeatures> value=ArrayList<Processor>
	...
	private HashMap mKey = new HashMap(32);		//the features and properties union, functions as key
	
	private boolean mDebug = false;				
			
	protected AbstractPool(){
		mProcessorCache = new HashMap(MAX_CACHE_SIZE); //we default to this, but allow it to grow
	...
	protected Object getProcessorFromCache(Map features, Map properties){					
		...
		ArrayList list = (ArrayList)mProcessorCache.get(mKey);
		...
		if (list == null) mProcessorCache.put(mKey,new ArrayList());
	...
	public void release(Object processor, Map features, Map properties) {			
		...
		if(list!=null) {
			...
			mProcessorCache.put(mKey,new ArrayList());			
			//try again
