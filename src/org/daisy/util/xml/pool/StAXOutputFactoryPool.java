...
public class StAXOutputFactoryPool extends AbstractPool {
	 ...
	 */
	public XMLOutputFactory acquire(Map<String,Object> properties) throws PoolException {
		try {
	 ...
	 */
	public void release(XMLOutputFactory xof, Map<String,Object> properties) throws PoolException {		  		
		try {			
	 ...
	 */
	private XMLOutputFactory create(Map<String,Object> properties) throws PoolException {
		XMLOutputFactory xof = XMLOutputFactory.newInstance();	    	    
	    return setProperties(xof,properties);		
	}
	
	private XMLOutputFactory setProperties(XMLOutputFactory xof, Map<String,Object> properties) throws PoolException {	     
	    if (properties != null){
