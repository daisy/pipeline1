...
public abstract class StaxFilter implements Closeable {
	...
	public StaxFilter(XMLEventReader xer, XMLEventFactory xef, XMLOutputFactory xof, OutputStream outStream) throws XMLStreamException {
        reader = xer;
        eventFactory = xef;
        outputFactory = xof;
    ...
    public StaxFilter(XMLEventReader xer, XMLEventFactory xef, OutputStream outStream) throws XMLStreamException {
        this(xer, xef, XMLOutputFactory.newInstance(), outStream);
    }
    
    public StaxFilter(XMLEventReader xer, XMLOutputFactory xof, OutputStream outStream) throws XMLStreamException {
