...
abstract class XmlFileImpl extends FilesetFileImpl implements XmlFile,
    ...
    XmlFileImpl(URI uri) throws ParserConfigurationException, SAXException, FileNotFoundException, IOException, MIMETypeException {
        super(uri, XmlFile.mimeStringConstant);
        initialize();
    }
    
    XmlFileImpl(URI uri, String mimeStringConstant) throws ParserConfigurationException, SAXException, FileNotFoundException, IOException, MIMETypeException {
        super(uri, mimeStringConstant);
        initialize();
    }

    XmlFileImpl(URI uri, ErrorHandler errh) throws ParserConfigurationException, SAXException, IOException, MIMETypeException {
        super(uri, XmlFile.mimeStringConstant);
    ...
    XmlFileImpl(URI uri, ErrorHandler errh, String mimeStringConstant) throws ParserConfigurationException, SAXException, IOException, MIMETypeException {
        super(uri, mimeStringConstant);
        if (errh instanceof FilesetErrorHandler) {
            this.listeningErrorHandler = (FilesetErrorHandler) errh;
        } else {
    ...
    private void initialize() throws ParserConfigurationException, SAXException {
        if (saxFactory == null) {
            ...
            try {
                ...
                System.err
                        .println("string-interning setfeature failed in xmlfileimpl");
            }
    ...
    private boolean getValidatingProperty() {
        try {
            if (System.getProperty("org.daisy.util.fileset.validating").equals(
                    "true")) {
    ...
    public InputSource resolveEntity(String publicId, String systemId)
        ...
        try {
            return CatalogEntityResolver.getInstance().resolveEntity(publicId,
                    systemId);
    ...
    public Document asDocument(boolean namespaceAware) throws ParserConfigurationException,
    ...
    public DOMSource asDOMSource() throws ParserConfigurationException,
            SAXException, IOException {
        return new DOMSource(this.asDocument(true));
    }
