...
final class PlsFileImpl extends PlayListImpl implements PlsFile {
	...
	private Map<String,String> fileTitlePairs = new HashMap<String,String>(); //<FileLine,TitleLine>
	...
	public String getHeadingForFile(File mp3File) {
		Iterator<String> i = fileTitlePairs.keySet().iterator();
		while(i.hasNext()) {
			String fileURL = i.next();
			if(fileURL.indexOf(mp3File.getName())>=0) {
				return fileTitlePairs.get(fileURL);
			}
		}
		return null;
	}
