...
public interface ISpeechPhraseReplacements extends Com4jObject,Iterable<Com4jObject> {
   ...
   * @return  Returns a value of type se_tpb_speechgen2.external.win.sapi5.ISpeechPhraseReplacement
   */

  @DISPID(0) //= 0x0. The runtime will prefer the VTID if present
  @VTID(8)
  @DefaultMethod
  se_tpb_speechgen2.external.win.sapi5.ISpeechPhraseReplacement item(
    int index);
