...
public interface ISpObjectTokenCategory extends se_tpb_speechgen2.external.win.sapi5.onecore.ISpDataKey {
  // Methods:
  /**
  ...
  /**
   * @param spdkl Mandatory se_tpb_speechgen2.external.win.sapi5.onecore.SPDATAKEYLOCATION parameter.
   * @return  Returns a value of type se_tpb_speechgen2.external.win.sapi5.onecore.ISpDataKey
   */

  @VTID(17)
  se_tpb_speechgen2.external.win.sapi5.onecore.ISpDataKey getDataKey(
    se_tpb_speechgen2.external.win.sapi5.onecore.SPDATAKEYLOCATION spdkl);
  ...
  @VTID(18)
  se_tpb_speechgen2.external.win.sapi5.onecore.IEnumSpObjectTokens enumTokens(
