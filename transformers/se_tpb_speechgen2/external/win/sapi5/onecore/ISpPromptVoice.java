...
public interface ISpPromptVoice extends Com4jObject {
  ...
  /**
   * @param pLoader Mandatory se_tpb_speechgen2.external.win.sapi5.onecore.ISpeechResourceLoader parameter.
   */

  @VTID(6)
  void setResourceLoader(
    se_tpb_speechgen2.external.win.sapi5.onecore.ISpeechResourceLoader pLoader);
