...
public interface ISpNotifySource extends Com4jObject {
  // Methods:
  /**
   * @param pNotifySink Mandatory se_tpb_speechgen2.external.win.sapi5.onecore.ISpNotifySink parameter.
   */

  @VTID(3)
  void setNotifySink(
    se_tpb_speechgen2.external.win.sapi5.onecore.ISpNotifySink pNotifySink);
