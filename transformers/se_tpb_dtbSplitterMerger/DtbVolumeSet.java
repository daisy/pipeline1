 ...
 */
public class DtbVolumeSet extends ArrayList<DtbVolume> {
 ...
 */
	public HashMap<Integer,List<?>> extractSmilSet() {
		HashMap<Integer,List<?>> smilSet = new HashMap<Integer,List<?>>();
		/*
		 * Extract volumes from the DtbVolumeSet as an Iterator.
		 * DtbVolumeSet is a List.
		 */
		Iterator<DtbVolume> volumes = this.iterator();
		while(volumes.hasNext()){
			DtbVolume vol = volumes.next();
