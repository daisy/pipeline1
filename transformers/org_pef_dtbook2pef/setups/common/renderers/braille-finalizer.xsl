...
<!--
		...
		The Braille finalizer performs post rendering character replacing.
		The purpose is to replace remaining non braille characters that are
		needed in the layout process, such as space, no-break space, hyphen
		and soft hyphen.

		It takes two parameters: finalizer-input and finalizer-output.
